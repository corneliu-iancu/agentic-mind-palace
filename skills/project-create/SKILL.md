...
Read the Projects `id` (a **data source ID**) from it.
...
The Projects `id` in the state file is a **data source ID** — pass it as `data_source_id`, not `database_id`, or the create fails with 404.
